...
const newsData: NewsArticle[] = [
  { id: 1, title: "NAITA Mobile Application", content: "Building a Skilled Nation with NAITA...", date: "2025-09-10", category: "Technology", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", featured: true },
  { id: 2, title: "Graduation Ceremony 2025", content: "Celebrating the achievements of our graduates...", date: "2025-08-20", category: "Events", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", featured: true },
  { id: 3, title: "New Training Program Launch", content: "Introducing advanced training programs...", date: "2025-09-05", category: "Programs", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", featured: false },
];
...
const NewsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8 text-center text-slate-900">More News & Announcements</h1>
